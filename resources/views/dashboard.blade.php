<x-app-layout>
 ...
 <p class="text-green-700">Ver el catálogo completo de Servicios desde la base de datos</p>
 </a>
 ...
 <p class="text-red-700">Ver el catálogo completo de Citas desde la base de datos</p>
 </a>
 <a href="{{ route('reports.index') }}"
 class="block p-6 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100">
 <h5 class="font-bold text-red-900">📄Reportes y Exportación</h5>
 <p class="text-red-700">Genera PDFs, exporta a Excel y visualiza estadísticas</p>
</a>
